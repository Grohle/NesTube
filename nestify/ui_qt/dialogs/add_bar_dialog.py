"""
nestify/ui_qt/dialogs/add_bar_dialog.py
...
from nestify.stock_db import StockBar, get_available_bars
import nestify.ui_qt.theme_qt as _th
from nestify.ui_qt.forms.ui_add_bar_dialog import Ui_AddBarDialog
