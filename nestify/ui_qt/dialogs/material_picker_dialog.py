"""
nestify/ui_qt/dialogs/material_picker_dialog.py
...
from nestify.materials_db import Material, get_materials, search_materials
import nestify.ui_qt.theme_qt as _th
from nestify.ui_qt.forms.ui_material_picker_dialog import Ui_MaterialPickerDialog
