"""
nestify/ui_qt/dialogs/stock_add_dialog.py
...
from nestify.materials_db import get_material_names
from nestify.stock_db import StockBar
import nestify.ui_qt.theme_qt as _th
from nestify.ui_qt.forms.ui_stock_add_dialog import Ui_StockAddDialog
