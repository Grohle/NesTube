"""
nestify/ui_qt/dialogs/nesting_selector_dialog.py
...
class NestingSelectorDialog(QDialog):
    ...
    def __init__(
        ...
        for i, ctx in enumerate(contexts):
            if i == active_index:
                ...
                from nestify.context_sync import effective_barras
    ...
    def selected_nestings(self) -> List[Dict[str, Any]]:
        ...
        if not self._rows:
            return []
        from nestify.nesting_export import build_context_export_data, context_section_height
        from nestify.bevel_geom import profile_section_height as _psh
