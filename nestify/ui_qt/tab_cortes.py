...
from nestify.nesting_viz import compute_nesting_canvas_layout
...
from nestify.ui_qt.widgets.corte_row import CorteRow
from nestify.ui_qt.forms.ui_tab_cortes import Ui_TabCortes
...
class TabCortes(QWidget):
    ...
    def __init__(
        ...
        # attributes and wired by NestifyApp after construction. They are
    ...
    def _on_material_selected(self, sel) -> None:
        ...
        """
        from nestify.ui_qt.dialogs.stock_material_search_dialog import SRC_STOCK
        ensure_material_contexts(self._state)
        set_material_selection(
