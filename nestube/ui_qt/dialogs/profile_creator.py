"""
nestube/ui_qt/dialogs/profile_creator.py
...
class ProfileCreator(QDialog):
    ...
    def _shapes_from_geometry(meta: dict) -> List["ProfileShape"]:
        ...
        try:
            from nestube.profile_geometry import section_contours
    ...
    def _generate_wkt(self) -> str:
        try:
            from nestube.geometry_engine import polygon_from_profile_shapes
