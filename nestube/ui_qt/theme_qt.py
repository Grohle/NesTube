"""
nestube/ui_qt/theme_qt.py
Color palette and QSS stylesheet for the Qt UI.
Mirrors nestube/nestube/nestube/theme.py but outputs QSS instead of CTk kwargs.
"""
...
def build_stylesheet(mode: str = "dark", font_family: str = "IBM Plex Sans",
    ...
    _chev_down = os.path.join(_tmp, "nestube_chevron_down.svg")
    _chev_up   = os.path.join(_tmp, "nestube_chevron_up.svg")
    try:
