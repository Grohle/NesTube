"""
nestube/ui_qt/widgets/material_autocomplete.py
...
class MaterialAutocomplete(QWidget):
    ...
    def _material_suggestions(self, text: str) -> List[str]:
        ...
        try:
            from nestube.materials_db import get_materials_db
    ...
    def _open_picker(self) -> None:
        try:
            from nestube.ui_qt.dialogs.material_picker_dialog import MaterialPickerDialog
