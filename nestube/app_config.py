"""
nestube/nestube/nestube/app_config.py
Persistent application preferences — nestube_config.json at project root.
"""
...
# Project root (parent of nestube package)
_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
CONFIG_FILENAME = "nestube_config.json"
...
def load() -> AppPreferences:
    ...
    the DB has no config but a legacy nestube_config.json exists, it is imported
